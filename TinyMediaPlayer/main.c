#include "Win32/TinyPTC/tinyptc.h"
...
static unsigned int sdl_refresh_timer_cb(unsigned int interval, void *opaque)
{
    //SDL_Event event;
...
void show_help(void)
{
    printf("ffplay version, Copyright (c) 2003-2006 Fabrice Bellard, et al.\n"
