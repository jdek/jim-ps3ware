...
const uint8_t  ALIGN(8) dither_2x2_4[2][8]={
{  1,   3,   1,   3,   1,   3,   1,   3, },
{  2,   0,   2,   0,   2,   0,   2,   0, },
};

const uint8_t  ALIGN(8) dither_2x2_8[2][8]={
{  6,   2,   6,   2,   6,   2,   6,   2, },
{  0,   4,   0,   4,   0,   4,   0,   4, },
};

const uint8_t  ALIGN(8) dither_8x8_32[8][8]={
...
#if 0
const uint8_t  ALIGN(8) dither_8x8_64[8][8]={
...
const uint8_t  ALIGN(8) dither_8x8_73[8][8]={
...
#if 0
const uint8_t  ALIGN(8) dither_8x8_128[8][8]={
...
#if 1
const uint8_t  ALIGN(8) dither_8x8_220[8][8]={
...
static uint64_t attribute_used ALIGN(8) mmx_00ffw   = 0x00ff00ff00ff00ffULL;
static uint64_t attribute_used ALIGN(8) mmx_redmask = 0xf8f8f8f8f8f8f8f8ULL;
static uint64_t attribute_used ALIGN(8) mmx_grnmask = 0xfcfcfcfcfcfcfcfcULL;

static uint64_t attribute_used ALIGN(8) M24A=   0x00FF0000FF0000FFULL;
static uint64_t attribute_used ALIGN(8) M24B=   0xFF0000FF0000FF00ULL;
static uint64_t attribute_used ALIGN(8) M24C=   0x0000FF0000FF0000ULL;

// the volatile is required because gcc otherwise optimizes some writes away not knowing that these
// are read in the asm block
static volatile uint64_t attribute_used ALIGN(8) b5Dither;
static volatile uint64_t attribute_used ALIGN(8) g5Dither;
static volatile uint64_t attribute_used ALIGN(8) g6Dither;
static volatile uint64_t attribute_used ALIGN(8) r5Dither;

static uint64_t ALIGN(8) dither4[2]={
    0x0103010301030103LL,
    0x0200020002000200LL,};

static uint64_t ALIGN(8) dither8[2]={
